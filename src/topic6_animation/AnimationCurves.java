...
//			Vector.lerp(p0, p1, t)
	...
	DoubleUnaryOperator[] functions = new DoubleUnaryOperator[] {
			...
			x -> x * x * (3 - 2*x),                                      // EaseInOut quadratic (smoothstep)
			
			x -> x * x * x * (x * (x * 6 - 15) + 10),                    // EaseInOut qubic (smootherstep)
			
			x -> x*x,                                                    // EaseIn quadratic
			
			x -> 1-(1-x)*(1-x),                                          // EaseOut quadratic
			
			x -> 1-((x=1-x) * x * (2.70158 * x - 1.70158)),              // EaseOut back
