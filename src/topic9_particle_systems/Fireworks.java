...
class Firework {
	...
	private final Vector[] p;                         // Pocetni polozaji cestica.
	private final Vector[] v;                         // Brzine cestica.

	private final double timeStart;                   // Vreme pocetka vatrometa.
	private final double hue;                         // Hue vatrometa.
